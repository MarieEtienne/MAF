...
* Dans le cas de l'AFM, la matrice $V$ est la matrice de covariance et $M = Diag( s_k^{-1} \lambda_{c_k}^{-1})$.
...
[Trouver les axes principaux dans ces méthodes se résume à trouver les vecteurs propres de  $MVM$]{.rouge}

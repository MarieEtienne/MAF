...
$$M = Diag\left (\frac{1}{s_1 \lambda_{c_1},\ldots ,\frac{1}{s_p \lambda_{c_p} \right)$$
où Diag désigne la matrice diagonale, le terme $i$ est donné par  $\frac{1}{s_i \lambda_{c_i},$ $s_i$ est l'écart type de la variable $i$ et $\lambda_{c_i}$ est la première valeur propre de la classe à laquelle appartient la variable  $i$.

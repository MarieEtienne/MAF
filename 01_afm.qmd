...
\begin{align}
X & = \begin{pmatrix}
\class{bleu}{\frac{X^{1}_1}{\lambda_{11}}} & \class{bleu}{\frac{X^{2}_1}{\lambda_{11}}}  &  \class{bleu}{\frac{X^{3}_1}{\lambda_{11}}} & \class{orange}{\frac{X^{4}_1}{\lambda_{21}}}& \class{orange}{\frac{X^{5}_1}{\lambda_{21}}} & \class{vert}{\frac{X^{6}_1}{\lambda_{31}}}& \class{vert}{\frac{X^{7}_1}{\lambda_{31}}} \\
\class{bleu}{\vdots} & \class{bleu}{\vdots}  &  \class{bleu}{\vdots} & \class{orange}{\vdots}& \class{orange}{\vdots} & \class{vert}{\vdots}& \class{vert}{\vdots} \\
\class{bleu}{\frac{X^{1}_n}{\lambda_{11}}} & \class{bleu}{\frac{X^{2}_n}{\lambda_{11}}}  &  \class{bleu}{\frac{X^{3}_n}{\lambda_{11}}} & \class{orange}{\frac{X^{4}_n}{\lambda_{21}}} & \class{orange}{\frac{X^{5}_n}{\lambda_{21}}} & \class{vert}{\frac{X^{6}_n}{\lambda_{31}}}& \class{vert}{\frac{X^{7}_n}{\lambda_{31}}} \\
\end{pmatrix}\\
 & = \begin{pmatrix}
\class{bleu}{\frac{\boldsymbol{X^{1}}}{\lambda_{11}}} &  \class{orange}{\frac{\boldsymbol{X^{2}}}{\lambda_{21}}}  & \class{vert}{\frac{\boldsymbol{X^{3}}}{\lambda_{31}}} \\
\end{pmatrix}\\
\end{align}
...
* Les points sont potentiellement pondérés avec lamatrice de poids  $W \in \R^{n\times n}$,
* on utilise la mérique 
$$M = Diag\left (\frac{1}{s_1 \lambda_{g_1},\ldots ,\frac{1}{s_p \lambda_{g_p} \right)$$
où Diag désigne la matrice diagonale, le terme $i$ est donné par  $\frac{1}{s_i \lambda_{g_i},$ $s_i$ est l'écart type de la variable $i$ et $\lambda_{g_i}$ est la première valeur propre du groupe de variable auquel appartient la variable  $i$.
...
doubs_mfa <- MFA(doubs.env, 
    ...
    name.group=c("Physique","Chimique","Ecologique"), graph = FALSE)
#summary(doubs_mfa)
# library(Factoshiny)
# MFAshiny(doubs_mfa)
